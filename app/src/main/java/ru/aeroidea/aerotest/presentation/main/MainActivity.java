...
import ru.aeroidea.aerotest.presentation.screens.BasketScreen;
import ru.aeroidea.aerotest.presentation.screens.CatalogScreen;
import ru.aeroidea.aerotest.presentation.screens.HomeScreen;
import ru.aeroidea.aerotest.presentation.screens.MainScreen;
import ru.aeroidea.aerotest.presentation.screens.ProfileScreen;
import ru.aeroidea.aerotest.presentation.screens.SalesScreen;
...
public class MainActivity extends BaseActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private void initTabScreens() {
        ...
        mTabScreenMap.put(R.id.action_catalog, new TabScreen(new CatalogScreen()));
        mTabScreenMap.put(R.id.action_sales, new TabScreen(new SalesScreen()));
        mTabScreenMap.put(R.id.action_profile, new TabScreen(new ProfileScreen()));
        mTabScreenMap.put(R.id.action_basket, new TabScreen(new BasketScreen()));
    }
